...
public class Demo {
    public static void main(String[] args) {
       ...
       // System.out.println(productDAO.findById(300l).toString());
        //System.out.println(productDAO.findByName("bed"));
        // System.out.println(productDAO.findByContainedName("idge"));
         System.out.println(productDAO.findByPrice(150,100));
        //System.out.println(productDAO.findByNameSortedDesc("Lev2").toString());
       // System.out.println(productDAO.findByPriceSortedDesc(1500,1000));
